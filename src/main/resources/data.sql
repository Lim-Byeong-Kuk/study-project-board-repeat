...
('lbk', '1234', 'Forest', 'lbk@mail.com', 'I am lbk.', now(), 'lbk', now(), 'lbk')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
('lbk2', '1234', 'Forest2', 'lbk2@mail.com', 'I am lbk2.', now(), 'lbk2', now(), 'lbk2')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
('lbk3', '1234', 'Forest3', 'lbk3@mail.com', 'I am lbk3.', now(), 'lbk3', now(), 'lbk3')
;
